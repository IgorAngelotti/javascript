let num = [7, 5, 9, 3, 4, 0]
num.push(6) //CRIA MAIS UMA CHAVE (A ULTIMA, QUE NESSE EXEMPLO SERIA A CHAVE 6) COM O VALOR = "7"
...
console.log(num)
console.log(`O vetor tem ${num.length} elementos, sendo o primeiro valor ${num[0]} e o ultimo ${num[7]}.`)
